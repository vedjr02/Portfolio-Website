          ...
          >
            <div className="flex items-center justify-between border-b border-line px-5 py-4">
              ...
              <button
                type="button"
                onClick={onClose}
                className="rounded-full border border-line px-3 py-1.5 text-sm font-semibold text-ink-soft hover:text-ink"
              >
                Close
              </button>
            </div>
            ...
            <div className="flex-1 overflow-y-auto px-5 py-6">
              ...
              {project.metric && (
                <div className="mt-8 rounded-3xl bg-bg p-5 border border-line">
